 ...
 * 
 * <p>This class extends {@link Equipment} and adds fields specific to
 ...
 * for biomedical equipment inside institutional environments.</p>
 *
 * <p>Instances are stored in the {@code biomedical_equiments} table.</p>
 */
@Entity
...
public class BiomedicalEquipment extends Equipment {
     ...
     *
     * <p>This constructor is kept for compatibility but should not be used in
     * new code, as IDs are managed by the persistence layer.</p>
     */
    @Deprecated
    public BiomedicalEquipment(Long id, String serial, String brand, String model,
            EquipmentType type, EquipmentStatus state,
            String imagePath, String riskClass, String calibrationCert, Provider provider) {
